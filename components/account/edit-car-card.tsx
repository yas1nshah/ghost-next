...
const CarCard = (params : any) => {
    ...
    return (
        ...
        <Link key={car.id} href={``}  className={`bg-card ${car.featuredCar && "border-2 border-secondary"}  h-28 mx-0 md:h-40 md:px-2 w-full flex rounded-xl dark:text-white text-nowrap my-4 `}>
